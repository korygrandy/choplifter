...
Fly to one of four barracks.

Shoot the building to release the 16 hostages inside.

Land (carefully) to board them. If you land on a hostage, they are crushed—a detail noted for its emotional impact on players.

Return to the "Poste" (base) while dodging tanks and jets.
...
Would you like me to look for specific cheat codes or PKE (Peek/Poke) addresses for the C64 version so you can modify the game's difficulty?
