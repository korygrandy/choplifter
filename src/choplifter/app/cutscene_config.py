...
HOSTAGE_RESCUE_CUTSCENE_BY_MISSION = {
    ...
    "airport": "hostage-rescue-cutscene.avi",
    "airport_special_ops": "hostage-rescue-cutscene.avi",
    "airportspecialops": "hostage-rescue-cutscene.avi",
    "mission2": "hostage-rescue-cutscene.avi",
    "m2": "hostage-rescue-cutscene.avi",
